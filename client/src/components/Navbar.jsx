            ...
            <div> <Link to="/"><img src={logoImage} alt="" height={50} width={50} className='rounded-full' /></Link> </div>
            {
                user ?
                    <div className='flex items-center gap-2 sm:gap-3'>
                        <Link to='/buy'>
                        <button className='flex cursor-pointer items-center gap-2 bg-blue-100 px-4 sm:px-6 py-15 sm:py-3 rounded-full hover:scale-105 transition-all duration-700'>
